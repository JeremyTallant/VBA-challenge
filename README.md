...
For this assignment we were given a big dataset of stock information where we were instructed to create a VBA script that loops through all the stocks for one year and outputs the following information: 
* Ticker symbol
